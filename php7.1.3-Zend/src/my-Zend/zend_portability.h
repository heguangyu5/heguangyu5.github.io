...
#if ((defined(__GNUC__) && ZEND_GCC_VERSION >= 4005) || __has_builtin(__builtin_unreachable)) && PHP_HAVE_BUILTIN_EXPECT
...
#if (HAVE_ALLOCA || (defined (__GNUC__) && __GNUC__ >= 2)) && !defined(DARWIN)
